...
& (Join-Path $PSScriptRoot '../operations/check_ports.ps1')
& (Join-Path $PSScriptRoot '../verification/verify_scenechat_snapshot.ps1') | Out-Host
...
try {
    & (Join-Path $PSScriptRoot '../operations/run.ps1') -LockConfiguration
    ...
    if ($StartedServices) { & (Join-Path $PSScriptRoot '../operations/stop.ps1') }
}
